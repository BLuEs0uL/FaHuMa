...
subtitle: function(data) {
	const channels = ['Komutu Kullananın Kanala', 'Etiketli Kişinin Kanala', 'Varsayılan Ses Kanalına', 'Geçici Değişken', 'Sunucu Değişkeni', 'Evrensel Değişken'];
